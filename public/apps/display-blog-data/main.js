...
$c_Lcom_raquo_laminar_DomApi$.prototype.setHtmlProperty__Lcom_raquo_laminar_nodes_ReactiveHtmlElement__Lcom_raquo_domtypes_generic_keys_Prop__O__V = (function(element, prop, value) {
  $n($n(prop).Lcom_raquo_laminar_keys_ReactiveProp__f_codec);
  $n(element).Lcom_raquo_laminar_nodes_ReactiveHtmlElement__f_ref[$n(prop).Lcom_raquo_laminar_keys_ReactiveProp__f_name] = value
});
...
/** @constructor */
function $c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$() {
  /*<skip>*/
}
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$.prototype = new $h_O();
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$.prototype.constructor = $c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$;
/** @constructor */
function $h_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$() {
  /*<skip>*/
}
$h_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$.prototype = $c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$.prototype;
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$.prototype.renderPosts__sjs_js_Array__Lcom_raquo_laminar_nodes_ReactiveHtmlElement = (function(posts) {
  var $$x13 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).div__O()));
  var $$x12 = $m_sr_ScalaRunTime$();
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var len = $uI(posts.length);
  ...
  while ((i < len)) {
    ...
    var $$x8 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).h2__O()));
    var $$x7 = $m_sr_ScalaRunTime$();
    var $$x6 = $as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).a__O());
    var $$x5 = $m_sr_ScalaRunTime$();
    var $$x4 = $n($as_Lcom_raquo_laminar_keys_ReactiveProp($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).href__O())).$colon$eq__O__Lcom_raquo_laminar_modifiers_Setter((($as_T(window.location.pathname) + "?page=blog-post&id=") + $uI(arg1.id)));
    $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
    var this$3 = $n($as_T(arg1.title));
    var text = $as_T(this$3.toUpperCase());
    var $$x3 = $n($$x8).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x7).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$n($$x6).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x5).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$$x4, new $c_Lcom_raquo_laminar_nodes_TextNode(text)])))])));
    var $$x2 = $as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).div__O());
    var $$x1 = $m_sr_ScalaRunTime$();
    $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
    var text$1 = $as_T(new Date($as_T(arg1.date)).toISOString());
    res[$$x11] = $n($$x10).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x9).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$$x3, $n($$x2).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x1).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([new $c_Lcom_raquo_laminar_nodes_TextNode(text$1)])))])));
    i = ((1 + i) | 0)
  };
  var nodes = $ct_sjs_js_WrappedArray__sjs_js_Array__(new $c_sjs_js_WrappedArray(), res);
  return $n($$x13).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x12).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([new $c_Lcom_raquo_laminar_Implicits$$anon$3(nodes)])))
});
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$.prototype.blogListPage__I__I__Lcom_raquo_laminar_nodes_ReactiveHtmlElement = (function(offset, size) {
  var $$x32 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).div__O()));
  var $$x31 = $m_sr_ScalaRunTime$();
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).display__Lcom_raquo_domtypes_generic_defs_styles_Styles$display$();
  var $$x30 = $m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style, "flex");
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$1 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).flexDirection__Lcom_raquo_domtypes_generic_defs_styles_Styles$flexDirection$();
  var $$x29 = $m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$1, "column");
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$2 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).alignItems__Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$();
  var $$x28 = $m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$2, "center");
  var $$x27 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).h1__O())).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L), new $c_Lcom_raquo_laminar_nodes_TextNode("My Blog Posts"))])));
  var $$x26 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).hr__O()));
  var $$x25 = $m_sr_ScalaRunTime$();
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$3 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).width__Lcom_raquo_domtypes_generic_defs_styles_StylesMisc$AutoStyle();
  var $$x24 = $n($$x26).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x25).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$3, "100%")])));
  var $$x23 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).div__O()));
  var $$x22 = $m_sr_ScalaRunTime$();
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var text = ((offset + " - ") + ((offset + size) | 0));
  var $$x21 = $n($$x23).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x22).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([new $c_Lcom_raquo_laminar_nodes_TextNode(text)])));
  var $$x20 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).div__O()));
  var $$x19 = $m_sr_ScalaRunTime$();
  var array = BlogData.posts;
  var until = ((offset + size) | 0);
  var self = array.slice(((offset > 0) ? offset : 0), ((until > 0) ? until : 0));
  var $$x18 = $n($$x20).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x19).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$m_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$().renderPosts__sjs_js_Array__Lcom_raquo_laminar_nodes_ReactiveHtmlElement(self)])));
  var $$x17 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).hr__O()));
  var $$x16 = $m_sr_ScalaRunTime$();
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$4 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).width__Lcom_raquo_domtypes_generic_defs_styles_StylesMisc$AutoStyle();
  var $$x15 = $n($$x17).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x16).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$4, "100%")])));
  var $$x14 = $as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).div__O());
  var $$x13 = $m_sr_ScalaRunTime$();
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$5 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).padding__Lcom_raquo_domtypes_generic_keys_Style();
  var $$x12 = $m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$5, "8px");
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$6 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).display__Lcom_raquo_domtypes_generic_defs_styles_Styles$display$();
  var $$x11 = $m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$6, "flex");
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$7 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).justifyContent__Lcom_raquo_domtypes_generic_defs_styles_Styles$justifyContent$();
  var $$x10 = $m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$7, "space-between");
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$8 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).alignItems__Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$();
  var $$x9 = $m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$8, "center");
  var $$x8 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).a__O()));
  var $$x7 = $m_sr_ScalaRunTime$();
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$9 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).paddingRight__Lcom_raquo_domtypes_generic_keys_Style();
  var $$x6 = $n($$x8).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x7).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$9, "12px"), $n($as_Lcom_raquo_laminar_keys_ReactiveProp($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).href__O())).$colon$eq__O__Lcom_raquo_laminar_modifiers_Setter((((($as_T(window.location.pathname) + "?offset=") + ((offset - size) | 0)) + "&size=") + size)), ($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L), new $c_Lcom_raquo_laminar_nodes_TextNode("Back"))])));
  var $$x5 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).a__O()));
  var $$x4 = $m_sr_ScalaRunTime$();
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$10 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).paddingLeft__Lcom_raquo_domtypes_generic_keys_Style();
  var $$x3 = $n($$x5).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x4).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$10, "12px"), $n($as_Lcom_raquo_laminar_keys_ReactiveProp($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).href__O())).$colon$eq__O__Lcom_raquo_laminar_modifiers_Setter(("" + $as_T(window.location.pathname))), ($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L), new $c_Lcom_raquo_laminar_nodes_TextNode("Home"))])));
  var $$x2 = $as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).a__O());
  var $$x1 = $m_sr_ScalaRunTime$();
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$11 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).paddingLeft__Lcom_raquo_domtypes_generic_keys_Style();
  return $n($$x32).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x31).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$$x30, $$x29, $$x28, $$x27, $$x24, $$x21, $$x18, $$x15, $n($$x14).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x13).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$$x12, $$x11, $$x10, $$x9, $$x6, $$x3, $n($$x2).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x1).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$11, "12px"), $n($as_Lcom_raquo_laminar_keys_ReactiveProp($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).href__O())).$colon$eq__O__Lcom_raquo_laminar_modifiers_Setter((((($as_T(window.location.pathname) + "?offset=") + ((offset + size) | 0)) + "&size=") + size)), ($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L), new $c_Lcom_raquo_laminar_nodes_TextNode("Next"))])))])))])))
});
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$.prototype.blogListByTag__T__Lcom_raquo_laminar_nodes_ReactiveHtmlElement = (function(tag) {
  var $$x20 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).div__O()));
  var $$x19 = $m_sr_ScalaRunTime$();
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).display__Lcom_raquo_domtypes_generic_defs_styles_Styles$display$();
  var $$x18 = $m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style, "flex");
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$1 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).flexDirection__Lcom_raquo_domtypes_generic_defs_styles_Styles$flexDirection$();
  var $$x17 = $m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$1, "column");
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$2 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).alignItems__Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$();
  var $$x16 = $m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$2, "center");
  var $$x15 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).h1__O()));
  var $$x14 = $m_sr_ScalaRunTime$();
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var text = ("Blog Posts In " + tag);
  var $$x13 = $n($$x15).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x14).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([new $c_Lcom_raquo_laminar_nodes_TextNode(text)])));
  var $$x12 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).hr__O()));
  var $$x11 = $m_sr_ScalaRunTime$();
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$3 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).width__Lcom_raquo_domtypes_generic_defs_styles_StylesMisc$AutoStyle();
  var $$x10 = $n($$x12).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x11).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$3, "100%")])));
  var array = BlogData.posts;
  var res = [];
  var len = $uI(array.length);
  var i = 0;
  while ((i < len)) {
    var arg1 = array[i];
    var array$1 = arg1.tags;
    if ($m_sjs_js_ArrayOps$().contains$extension__sjs_js_Array__O__Z(array$1, tag)) {
      $uI(res.push(arg1))
    };
    i = ((1 + i) | 0)
  };
  var $$x9 = $m_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$().renderPosts__sjs_js_Array__Lcom_raquo_laminar_nodes_ReactiveHtmlElement(res);
  var $$x8 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).hr__O()));
  var $$x7 = $m_sr_ScalaRunTime$();
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$4 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).width__Lcom_raquo_domtypes_generic_defs_styles_StylesMisc$AutoStyle();
  var $$x6 = $n($$x8).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x7).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$4, "100%")])));
  var $$x5 = $as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).div__O());
  var $$x4 = $m_sr_ScalaRunTime$();
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$5 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).padding__Lcom_raquo_domtypes_generic_keys_Style();
  var $$x3 = $m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$5, "8px");
  var $$x2 = $as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).a__O());
  var $$x1 = $m_sr_ScalaRunTime$();
  $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
  var style$6 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).paddingLeft__Lcom_raquo_domtypes_generic_keys_Style();
  return $n($$x20).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x19).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$$x18, $$x17, $$x16, $$x13, $$x10, $$x9, $$x6, $n($$x5).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x4).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$$x3, $n($$x2).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x1).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$6, "12px"), $n($as_Lcom_raquo_laminar_keys_ReactiveProp($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).href__O())).$colon$eq__O__Lcom_raquo_laminar_modifiers_Setter(("" + $as_T(window.location.pathname))), ($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L), new $c_Lcom_raquo_laminar_nodes_TextNode("Home"))])))])))])))
});
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$.prototype.blogPostPage__I__Lcom_raquo_laminar_nodes_ReactiveHtmlElement = (function(id) {
  var array = BlogData.posts;
  _return: {
    var len = $uI(array.length);
    var i = 0;
  ...
  var x2 = ((idx === (-1)) ? $m_s_None$() : new $c_s_Some(array[idx]));
  var x = $m_s_None$();
  if ((x === x2)) {
    return $m_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$().invalidParamPage__Lcom_raquo_laminar_nodes_ReactiveHtmlElement()
  };
  if ((x2 instanceof $c_s_Some)) {
    var post = $n($as_s_Some(x2)).s_Some__f_value;
    var $$x32 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).div__O()));
    var $$x31 = $m_sr_ScalaRunTime$();
    var $$x30 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).h1__O()));
    var $$x29 = $m_sr_ScalaRunTime$();
    $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
    var style = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).padding__Lcom_raquo_domtypes_generic_keys_Style();
    var $$x28 = $m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style, "8px");
    $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
    var text = $as_T(post.title);
    var $$x27 = $n($$x30).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x29).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$$x28, new $c_Lcom_raquo_laminar_nodes_TextNode(text)])));
    var $$x26 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).div__O()));
    var $$x25 = $m_sr_ScalaRunTime$();
    $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
    var array$1 = post.tags;
    ...
    while ((i$1 < len$1)) {
      ...
      var tag = $as_T(arg1$1);
      var $$x23 = $as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).span__O());
      var $$x22 = $m_sr_ScalaRunTime$();
      $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
      ...
      res[$$x24] = $n($$x23).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x22).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$1, "8px"), $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).a__O())).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$n($as_Lcom_raquo_laminar_keys_ReactiveProp($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).href__O())).$colon$eq__O__Lcom_raquo_laminar_modifiers_Setter((($as_T(window.location.pathname) + "?page=blog-list-by-tag&tag=") + tag)), ($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L), new $c_Lcom_raquo_laminar_nodes_TextNode(tag))])))])));
      i$1 = ((1 + i$1) | 0)
    };
    var nodes = $ct_sjs_js_WrappedArray__sjs_js_Array__(new $c_sjs_js_WrappedArray(), res);
    var $$x21 = $n($$x26).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x25).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([new $c_Lcom_raquo_laminar_Implicits$$anon$3(nodes)])));
    var $$x20 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).hr__O()));
    var $$x19 = $m_sr_ScalaRunTime$();
    $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
    var style$2 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).width__Lcom_raquo_domtypes_generic_defs_styles_StylesMisc$AutoStyle();
    var $$x18 = $n($$x20).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x19).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$2, "100%")])));
    var $$x17 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).div__O()));
    var $$x16 = $m_sr_ScalaRunTime$();
    $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
    var style$3 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).padding__Lcom_raquo_domtypes_generic_keys_Style();
    var $$x15 = $m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$3, "8px");
    $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
    var text$1 = $as_T(new Date($as_T(post.date)).toISOString());
    var $$x14 = $n($$x17).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x16).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$$x15, new $c_Lcom_raquo_laminar_nodes_TextNode(text$1)])));
    var $$x13 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).div__O()));
    var $$x12 = $m_sr_ScalaRunTime$();
    $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
    var style$4 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).padding__Lcom_raquo_domtypes_generic_keys_Style();
    var $$x11 = $m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$4, "8px");
    $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
    var array$2 = post.body;
    var len$2 = $uI(array$2.length);
    var res$1 = new Array(len$2);
    var i$2 = 0;
    while ((i$2 < len$2)) {
      var $$x10 = i$2;
      var arg1$2 = array$2[i$2];
      var line = $as_T(arg1$2);
      res$1[$$x10] = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).p__O())).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L), new $c_Lcom_raquo_laminar_nodes_TextNode(line))])));
      i$2 = ((1 + i$2) | 0)
    };
    var nodes$1 = $ct_sjs_js_WrappedArray__sjs_js_Array__(new $c_sjs_js_WrappedArray(), res$1);
    var $$x9 = $n($$x13).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x12).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$$x11, new $c_Lcom_raquo_laminar_Implicits$$anon$3(nodes$1)])));
    var $$x8 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).hr__O()));
    var $$x7 = $m_sr_ScalaRunTime$();
    $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
    var style$5 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).width__Lcom_raquo_domtypes_generic_defs_styles_StylesMisc$AutoStyle();
    var $$x6 = $n($$x8).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x7).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$5, "100%")])));
    var $$x5 = $as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).div__O());
    var $$x4 = $m_sr_ScalaRunTime$();
    $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
    var style$6 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).padding__Lcom_raquo_domtypes_generic_keys_Style();
    var $$x3 = $m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$6, "8px");
    var $$x2 = $as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).a__O());
    var $$x1 = $m_sr_ScalaRunTime$();
    $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
    var style$7 = $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).paddingLeft__Lcom_raquo_domtypes_generic_keys_Style();
    return $n($$x32).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x31).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$$x27, $$x21, $$x18, $$x14, $$x9, $$x6, $n($$x5).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x4).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$$x3, $n($$x2).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x1).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([$m_Lcom_raquo_laminar_keys_ReactiveStyle$().$colon$eq$extension__Lcom_raquo_domtypes_generic_keys_Style__O__Lcom_raquo_laminar_modifiers_Setter(style$7, "12px"), $n($as_Lcom_raquo_laminar_keys_ReactiveProp($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).href__O())).$colon$eq__O__Lcom_raquo_laminar_modifiers_Setter(("" + $as_T(window.location.pathname))), ($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L), new $c_Lcom_raquo_laminar_nodes_TextNode("Home"))])))])))])))
  };
  throw new $c_s_MatchError(x2)
});
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$.prototype.invalidParamPage__Lcom_raquo_laminar_nodes_ReactiveHtmlElement = (function() {
  return $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).div__O())).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L), new $c_Lcom_raquo_laminar_nodes_TextNode("Invalid Params"))])))
});
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$.prototype.renderApp__Lcom_raquo_airstream_ownership_Subscription = (function() {
  $m_Lcom_raquo_laminar_api_package$();
  var this$17 = $n($as_Lcom_raquo_airstream_core_BaseObservable($m_Lcom_raquo_laminar_api_Laminar$documentEvents$().onDomContentLoaded__O()));
  var onNext = new $c_sjsr_AnonFunction1(((_$3) => {
    var queryString = $as_T(window.location.search);
    var params = new URLSearchParams(queryString);
    matchResult3: {
      var page;
      var x5 = $m_s_Option$().apply__O__s_Option($as_T(params.get("page")));
      var x = $m_s_None$();
      if ((x === x5)) {
        var page = $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogList__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType();
        break matchResult3
      };
      if ((x5 instanceof $c_s_Some)) {
        var x13 = $as_T($n($as_s_Some(x5)).s_Some__f_value);
        switch (x13) {
          case "blog-list": {
            var page = $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogList__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType();
            break matchResult3;
          ...
          case "blog-list-by-tag": {
            var page = $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogListByTag__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType();
            break matchResult3;
            break
          }
          case "blog-post": {
            var page = $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogPost__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType();
            break matchResult3;
            break
          }
          default: {
            if ((x13 === "blog-data")) {
              var page = $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogData__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType();
              break matchResult3
            }
          }
        }
    ...
    matchResult8: {
      var body;
      var x$3 = $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogList__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType();
      if ((x$3 === null)) {
        var $$x1 = (page === null)
      } else {
        var this$2 = $n(x$3);
      ...
      if ($$x1) {
        matchResult4: {
          var offset;
          var x14 = $m_s_Option$().apply__O__s_Option($as_T(params.get("offset")));
          var x$5 = $m_s_None$();
          if ((x$5 === x14)) {
            var offset = 0;
            break matchResult4
          ...
          if ((x14 instanceof $c_s_Some)) {
            var n = $as_T($n($as_s_Some(x14)).s_Some__f_value);
            $m_sc_StringOps$();
            var this$5 = $m_jl_Integer$();
            var offset = this$5.parseInt__T__I__I(n, 10);
            break matchResult4
          };
        ...
        matchResult5: {
          var size;
          var x17 = $m_s_Option$().apply__O__s_Option($as_T(params.get("size")));
          var x$7 = $m_s_None$();
          if ((x$7 === x17)) {
            var size = 10;
            break matchResult5
          ...
          if ((x17 instanceof $c_s_Some)) {
            var n$2 = $as_T($n($as_s_Some(x17)).s_Some__f_value);
            $m_sc_StringOps$();
            var this$8 = $m_jl_Integer$();
            var size = this$8.parseInt__T__I__I(n$2, 10);
            break matchResult5
          };
          throw new $c_s_MatchError(x17)
        };
        var body = $m_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$().blogListPage__I__I__Lcom_raquo_laminar_nodes_ReactiveHtmlElement(offset, size);
        break matchResult8
      };
      var x$9 = $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogListByTag__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType();
      if ((x$9 === null)) {
        var $$x2 = (page === null)
      } else {
        var this$9 = $n(x$9);
      ...
      if ($$x2) {
        var x20 = $m_s_Option$().apply__O__s_Option($as_T(params.get("tag")));
        var x$11 = $m_s_None$();
        if ((x$11 === x20)) {
          var body = $m_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$().invalidParamPage__Lcom_raquo_laminar_nodes_ReactiveHtmlElement();
          break matchResult8
        };
        if ((x20 instanceof $c_s_Some)) {
          var tag = $as_T($n($as_s_Some(x20)).s_Some__f_value);
          var body = $m_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$().blogListByTag__T__Lcom_raquo_laminar_nodes_ReactiveHtmlElement(tag);
          break matchResult8
        };
        throw new $c_s_MatchError(x20)
      };
      var x$13 = $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogPost__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType();
      if ((x$13 === null)) {
        var $$x3 = (page === null)
      } else {
        var this$10 = $n(x$13);
      ...
      if ($$x3) {
        var x23 = $m_s_Option$().apply__O__s_Option($as_T(params.get("id")));
        var x$15 = $m_s_None$();
        if ((x$15 === x23)) {
          var body = $m_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$().invalidParamPage__Lcom_raquo_laminar_nodes_ReactiveHtmlElement();
          break matchResult8
        ...
        if ((x23 instanceof $c_s_Some)) {
          var id = $as_T($n($as_s_Some(x23)).s_Some__f_value);
          var $$x4 = $m_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$();
          $m_sc_StringOps$();
          var this$13 = $m_jl_Integer$();
          var body = $n($$x4).blogPostPage__I__Lcom_raquo_laminar_nodes_ReactiveHtmlElement(this$13.parseInt__T__I__I(id, 10));
          break matchResult8
        };
        throw new $c_s_MatchError(x23)
      };
      var x$17 = $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogData__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType();
      if ((x$17 === null)) {
        var $$x5 = (page === null)
      } else {
        var this$14 = $n(x$17);
      ...
      if ($$x5) {
        var $$x7 = $n($as_Lcom_raquo_laminar_builders_HtmlTag($n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).div__O()));
        var $$x6 = $m_sr_ScalaRunTime$();
        $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
        var text = $as_T(JSON.stringify(BlogData.posts));
        var body = $n($$x7).apply__sci_Seq__Lcom_raquo_laminar_nodes_ReactiveHtmlElement($n($$x6).wrapRefArray__AO__sci_ArraySeq(new ($d_Lcom_raquo_domtypes_generic_Modifier.getArrayOf().constr)([new $c_Lcom_raquo_laminar_nodes_TextNode(text)])));
        break matchResult8
      };
      throw new $c_s_MatchError(page)
    };
    var appContainer = document.body;
    $n($m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L);
    new $c_Lcom_raquo_laminar_nodes_RootNode(appContainer, body)
  }));
  $m_Lcom_raquo_laminar_api_package$();
  var owner = $m_Lcom_raquo_laminar_api_Laminar$unsafeWindowOwner$();
  return $f_Lcom_raquo_airstream_core_BaseObservable__foreach__F1__Lcom_raquo_airstream_ownership_Owner__Lcom_raquo_airstream_ownership_Subscription(this$17, onNext, owner)
});
var $d_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$ = new $TypeData().initClass({
  Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$: 0
}, false, "com.sustenage.menta.fontend.exercise.display.blog.data.App$package$", {
  Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$: 1,
  O: 1
});
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$.prototype.$classData = $d_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$;
var $n_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$;
function $m_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$() {
  if ((!$n_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$)) {
    $n_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$ = new $c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$()
  };
  return $n_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$
}
function $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_main__main__AT__V(args) {
  try {
    $m_Lcom_sustenage_menta_fontend_exercise_display_blog_data_App$package$().renderApp__Lcom_raquo_airstream_ownership_Subscription()
  } catch (e) {
    if (false) {
...
/** @constructor */
function $c_Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$(outer) {
  this.Lcom_raquo_domtypes_generic_keys_Style__f_name = null;
  if ((outer === null)) {
    throw new $c_jl_NullPointerException()
  };
  $ct_Lcom_raquo_domtypes_generic_keys_Style__T__(this, "align-items")
}
$c_Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$.prototype = new $h_Lcom_raquo_domtypes_generic_keys_Style();
$c_Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$.prototype.constructor = $c_Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$;
/** @constructor */
function $h_Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$() {
  /*<skip>*/
}
$h_Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$.prototype = $c_Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$.prototype;
var $d_Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$ = new $TypeData().initClass({
  Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$: 0
}, false, "com.raquo.domtypes.generic.defs.styles.Styles$alignItems$", {
  Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$: 1,
  Lcom_raquo_domtypes_generic_keys_Style: 1,
  Lcom_raquo_domtypes_generic_keys_Key: 1,
  O: 1
});
$c_Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$.prototype.$classData = $d_Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$;
/** @constructor */
...
/** @constructor */
function $c_Lcom_raquo_domtypes_generic_defs_styles_Styles$justifyContent$(outer) {
  this.Lcom_raquo_domtypes_generic_keys_Style__f_name = null;
  if ((outer === null)) {
    throw new $c_jl_NullPointerException()
  };
  $ct_Lcom_raquo_domtypes_generic_keys_Style__T__(this, "justify-content")
}
$c_Lcom_raquo_domtypes_generic_defs_styles_Styles$justifyContent$.prototype = new $h_Lcom_raquo_domtypes_generic_keys_Style();
$c_Lcom_raquo_domtypes_generic_defs_styles_Styles$justifyContent$.prototype.constructor = $c_Lcom_raquo_domtypes_generic_defs_styles_Styles$justifyContent$;
/** @constructor */
function $h_Lcom_raquo_domtypes_generic_defs_styles_Styles$justifyContent$() {
  /*<skip>*/
}
$h_Lcom_raquo_domtypes_generic_defs_styles_Styles$justifyContent$.prototype = $c_Lcom_raquo_domtypes_generic_defs_styles_Styles$justifyContent$.prototype;
var $d_Lcom_raquo_domtypes_generic_defs_styles_Styles$justifyContent$ = new $TypeData().initClass({
  Lcom_raquo_domtypes_generic_defs_styles_Styles$justifyContent$: 0
}, false, "com.raquo.domtypes.generic.defs.styles.Styles$justifyContent$", {
  Lcom_raquo_domtypes_generic_defs_styles_Styles$justifyContent$: 1,
  Lcom_raquo_domtypes_generic_keys_Style: 1,
  Lcom_raquo_domtypes_generic_keys_Key: 1,
  O: 1
});
$c_Lcom_raquo_domtypes_generic_defs_styles_Styles$justifyContent$.prototype.$classData = $d_Lcom_raquo_domtypes_generic_defs_styles_Styles$justifyContent$;
/** @constructor */
...
function $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogList__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType() {
  $m_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$();
  return $t_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogList
}
function $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogListByTag__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType() {
  $m_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$();
  return $t_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogListByTag
}
function $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogPost__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType() {
  $m_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$();
  return $t_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogPost
}
function $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogData__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType() {
  $m_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$();
  return $t_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogData
}
/** @constructor */
function $c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$() {
  $n_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$ = this;
  $t_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogList = new $c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1(0, "BlogList");
  $t_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogListByTag = new $c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1(1, "BlogListByTag");
  $t_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogPost = new $c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1(2, "BlogPost");
  $t_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogData = new $c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1(3, "BlogData");
  $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogList__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType();
  $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogListByTag__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType();
  $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogPost__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType();
  $s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogData__Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType()
}
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$.prototype = new $h_O();
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$.prototype.constructor = $c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$;
/** @constructor */
function $h_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$() {
  /*<skip>*/
}
$h_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$.prototype = $c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$.prototype;
var $d_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$ = new $TypeData().initClass({
  Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$: 0
}, false, "com.sustenage.menta.fontend.exercise.display.blog.data.PageType$", {
  Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$: 1,
  O: 1,
  s_deriving_Mirror: 1,
  s_deriving_Mirror$Sum: 1
});
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$.prototype.$classData = $d_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$;
var $n_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$;
function $m_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$() {
  if ((!$n_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$)) {
    $n_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$ = new $c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$()
  };
  return $n_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$
}
...
function $f_Lcom_raquo_airstream_core_WritableObservable__$init$__V($thiz) {
  $thiz.Lcom_raquo_airstream_custom_CustomStreamSource__f_externalObservers = [];
  $thiz.Lcom_raquo_airstream_custom_CustomStreamSource__f_internalObservers = []
}
...
function $f_Lcom_raquo_airstream_core_WritableObservable__addExternalObserver__Lcom_raquo_airstream_core_Observer__Lcom_raquo_airstream_ownership_Owner__Lcom_raquo_airstream_ownership_Subscription($thiz, observer, owner) {
  ...
  var this$ = $thiz.Lcom_raquo_airstream_custom_CustomStreamSource__f_externalObservers;
  this$.push(observer);
  return subscription
}
function $f_Lcom_raquo_airstream_core_WritableObservable__removeExternalObserverNow__Lcom_raquo_airstream_core_Observer__V($thiz, observer) {
  var removed = $m_Lcom_raquo_airstream_core_ObserverList$().removeObserverNow$extension__sjs_js_Array__O__Z($thiz.Lcom_raquo_airstream_custom_CustomStreamSource__f_externalObservers, observer);
  if (removed) {
...
function $p_Lcom_raquo_airstream_core_WritableObservable__maybeStart__V($thiz) {
  ...
  if (isStarting) {
    $f_Lcom_raquo_airstream_custom_CustomSource__onStart__V($thiz)
  }
}
function $p_Lcom_raquo_airstream_core_WritableObservable__maybeStop__V($thiz) {
  if ((!$f_Lcom_raquo_airstream_core_BaseObservable__isStarted__Z($thiz))) {
    $f_Lcom_raquo_airstream_custom_CustomSource__onStop__V($thiz)
  }
}
function $f_Lcom_raquo_airstream_core_WritableObservable__numAllObservers__I($thiz) {
  var this$ = $thiz.Lcom_raquo_airstream_custom_CustomStreamSource__f_externalObservers;
  var $$x1 = $uI(this$.length);
  var this$$1 = $thiz.Lcom_raquo_airstream_custom_CustomStreamSource__f_internalObservers;
...
$h_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType.prototype = $c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType.prototype;
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType.prototype.productIterator__sc_Iterator = (function() {
...
/** @constructor */
function $c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1(_$ordinal$2, \u03b4name$2) {
  this.Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1__f_$name$1 = null;
  this.Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1__f_$name$1 = \u03b4name$2
}
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1.prototype = new $h_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType();
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1.prototype.constructor = $c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1;
/** @constructor */
function $h_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1() {
  /*<skip>*/
}
$h_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1.prototype = $c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1.prototype;
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1.prototype.productArity__I = (function() {
  return 0
});
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1.prototype.productElement__I__O = (function(n) {
  return $f_sr_EnumValue__productElement__I__O(this, n)
});
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1.prototype.productPrefix__T = (function() {
  return this.Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1__f_$name$1
});
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1.prototype.toString__T = (function() {
  return this.Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1__f_$name$1
});
var $d_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1 = new $TypeData().initClass({
  Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1: 0
}, false, "com.sustenage.menta.fontend.exercise.display.blog.data.PageType$$anon$1", {
  Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1: 1,
  Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType: 1,
  O: 1,
  s_Equals: 1,
  s_Product: 1,
...
$c_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1.prototype.$classData = $d_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$$anon$1;
...
function $c_Lcom_raquo_laminar_api_Laminar$() {
  this.Lcom_raquo_laminar_api_Laminar$__f_href$lzy2 = null;
  this.Lcom_raquo_laminar_api_Laminar$__f_hrefbitmap$2 = false;
  this.Lcom_raquo_laminar_api_Laminar$__f_display$lzy2 = null;
  this.Lcom_raquo_laminar_api_Laminar$__f_displaybitmap$2 = false;
  this.Lcom_raquo_laminar_api_Laminar$__f_paddingRight$lzy1 = null;
  this.Lcom_raquo_laminar_api_Laminar$__f_paddingRightbitmap$1 = false;
  this.Lcom_raquo_laminar_api_Laminar$__f_paddingLeft$lzy1 = null;
  this.Lcom_raquo_laminar_api_Laminar$__f_paddingLeftbitmap$1 = false;
  ...
  this.Lcom_raquo_laminar_api_Laminar$__f_alignItems$lzy1 = null;
  this.Lcom_raquo_laminar_api_Laminar$__f_alignItemsbitmap$1 = false;
  this.Lcom_raquo_laminar_api_Laminar$__f_justifyContent$lzy1 = null;
  this.Lcom_raquo_laminar_api_Laminar$__f_justifyContentbitmap$1 = false;
  ...
  this.Lcom_raquo_laminar_api_Laminar$__f_p$lzy1 = null;
  this.Lcom_raquo_laminar_api_Laminar$__f_pbitmap$1 = false;
  this.Lcom_raquo_laminar_api_Laminar$__f_hr$lzy1 = null;
  this.Lcom_raquo_laminar_api_Laminar$__f_hrbitmap$1 = false;
  this.Lcom_raquo_laminar_api_Laminar$__f_div$lzy1 = null;
  this.Lcom_raquo_laminar_api_Laminar$__f_divbitmap$1 = false;
  this.Lcom_raquo_laminar_api_Laminar$__f_h1$lzy1 = null;
  this.Lcom_raquo_laminar_api_Laminar$__f_h1bitmap$1 = false;
  this.Lcom_raquo_laminar_api_Laminar$__f_h2$lzy1 = null;
  this.Lcom_raquo_laminar_api_Laminar$__f_h2bitmap$1 = false;
  this.Lcom_raquo_laminar_api_Laminar$__f_a$lzy2 = null;
  this.Lcom_raquo_laminar_api_Laminar$__f_abitmap$2 = false;
  this.Lcom_raquo_laminar_api_Laminar$__f_span$lzy1 = null;
  this.Lcom_raquo_laminar_api_Laminar$__f_spanbitmap$1 = false;
...
$c_Lcom_raquo_laminar_api_Laminar$.prototype.href__O = (function() {
  if ((!this.Lcom_raquo_laminar_api_Laminar$__f_hrefbitmap$2)) {
    var propCodec = $m_Lcom_raquo_domtypes_generic_codecs_package$StringAsIsCodec$();
    this.Lcom_raquo_laminar_api_Laminar$__f_href$lzy2 = new $c_Lcom_raquo_laminar_keys_ReactiveProp("href", propCodec);
    this.Lcom_raquo_laminar_api_Laminar$__f_hrefbitmap$2 = true
  };
  return this.Lcom_raquo_laminar_api_Laminar$__f_href$lzy2
});
...
$c_Lcom_raquo_laminar_api_Laminar$.prototype.paddingRight__Lcom_raquo_domtypes_generic_keys_Style = (function() {
  if ((!this.Lcom_raquo_laminar_api_Laminar$__f_paddingRightbitmap$1)) {
    this.Lcom_raquo_laminar_api_Laminar$__f_paddingRight$lzy1 = $ct_Lcom_raquo_domtypes_generic_keys_Style__T__(new $c_Lcom_raquo_domtypes_generic_keys_Style(), "padding-right");
    this.Lcom_raquo_laminar_api_Laminar$__f_paddingRightbitmap$1 = true
  };
  return this.Lcom_raquo_laminar_api_Laminar$__f_paddingRight$lzy1
});
$c_Lcom_raquo_laminar_api_Laminar$.prototype.paddingLeft__Lcom_raquo_domtypes_generic_keys_Style = (function() {
  if ((!this.Lcom_raquo_laminar_api_Laminar$__f_paddingLeftbitmap$1)) {
    this.Lcom_raquo_laminar_api_Laminar$__f_paddingLeft$lzy1 = $ct_Lcom_raquo_domtypes_generic_keys_Style__T__(new $c_Lcom_raquo_domtypes_generic_keys_Style(), "padding-left");
    this.Lcom_raquo_laminar_api_Laminar$__f_paddingLeftbitmap$1 = true
  };
  return this.Lcom_raquo_laminar_api_Laminar$__f_paddingLeft$lzy1
});
...
$c_Lcom_raquo_laminar_api_Laminar$.prototype.alignItems__Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$ = (function() {
  if ((!this.Lcom_raquo_laminar_api_Laminar$__f_alignItemsbitmap$1)) {
    this.Lcom_raquo_laminar_api_Laminar$__f_alignItems$lzy1 = new $c_Lcom_raquo_domtypes_generic_defs_styles_Styles$alignItems$(this);
    this.Lcom_raquo_laminar_api_Laminar$__f_alignItemsbitmap$1 = true
  };
  return this.Lcom_raquo_laminar_api_Laminar$__f_alignItems$lzy1
});
$c_Lcom_raquo_laminar_api_Laminar$.prototype.justifyContent__Lcom_raquo_domtypes_generic_defs_styles_Styles$justifyContent$ = (function() {
  if ((!this.Lcom_raquo_laminar_api_Laminar$__f_justifyContentbitmap$1)) {
    this.Lcom_raquo_laminar_api_Laminar$__f_justifyContent$lzy1 = new $c_Lcom_raquo_domtypes_generic_defs_styles_Styles$justifyContent$(this);
    this.Lcom_raquo_laminar_api_Laminar$__f_justifyContentbitmap$1 = true
  };
  return this.Lcom_raquo_laminar_api_Laminar$__f_justifyContent$lzy1
});
...
$c_Lcom_raquo_laminar_api_Laminar$.prototype.p__O = (function() {
  if ((!this.Lcom_raquo_laminar_api_Laminar$__f_pbitmap$1)) {
    this.Lcom_raquo_laminar_api_Laminar$__f_p$lzy1 = new $c_Lcom_raquo_laminar_builders_HtmlTag("p", false);
    this.Lcom_raquo_laminar_api_Laminar$__f_pbitmap$1 = true
  };
  return this.Lcom_raquo_laminar_api_Laminar$__f_p$lzy1
});
$c_Lcom_raquo_laminar_api_Laminar$.prototype.hr__O = (function() {
  if ((!this.Lcom_raquo_laminar_api_Laminar$__f_hrbitmap$1)) {
    this.Lcom_raquo_laminar_api_Laminar$__f_hr$lzy1 = new $c_Lcom_raquo_laminar_builders_HtmlTag("hr", true);
    this.Lcom_raquo_laminar_api_Laminar$__f_hrbitmap$1 = true
  };
  return this.Lcom_raquo_laminar_api_Laminar$__f_hr$lzy1
});
...
$c_Lcom_raquo_laminar_api_Laminar$.prototype.h1__O = (function() {
  if ((!this.Lcom_raquo_laminar_api_Laminar$__f_h1bitmap$1)) {
    this.Lcom_raquo_laminar_api_Laminar$__f_h1$lzy1 = new $c_Lcom_raquo_laminar_builders_HtmlTag("h1", false);
    this.Lcom_raquo_laminar_api_Laminar$__f_h1bitmap$1 = true
  };
  return this.Lcom_raquo_laminar_api_Laminar$__f_h1$lzy1
});
$c_Lcom_raquo_laminar_api_Laminar$.prototype.h2__O = (function() {
  if ((!this.Lcom_raquo_laminar_api_Laminar$__f_h2bitmap$1)) {
    this.Lcom_raquo_laminar_api_Laminar$__f_h2$lzy1 = new $c_Lcom_raquo_laminar_builders_HtmlTag("h2", false);
    this.Lcom_raquo_laminar_api_Laminar$__f_h2bitmap$1 = true
  };
  return this.Lcom_raquo_laminar_api_Laminar$__f_h2$lzy1
});
$c_Lcom_raquo_laminar_api_Laminar$.prototype.a__O = (function() {
  if ((!this.Lcom_raquo_laminar_api_Laminar$__f_abitmap$2)) {
    this.Lcom_raquo_laminar_api_Laminar$__f_a$lzy2 = new $c_Lcom_raquo_laminar_builders_HtmlTag("a", false);
    this.Lcom_raquo_laminar_api_Laminar$__f_abitmap$2 = true
  };
  return this.Lcom_raquo_laminar_api_Laminar$__f_a$lzy2
});
$c_Lcom_raquo_laminar_api_Laminar$.prototype.span__O = (function() {
  if ((!this.Lcom_raquo_laminar_api_Laminar$__f_spanbitmap$1)) {
    this.Lcom_raquo_laminar_api_Laminar$__f_span$lzy1 = new $c_Lcom_raquo_laminar_builders_HtmlTag("span", false);
    this.Lcom_raquo_laminar_api_Laminar$__f_spanbitmap$1 = true
  };
  return this.Lcom_raquo_laminar_api_Laminar$__f_span$lzy1
});
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
var $t_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogList = null;
var $t_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogListByTag = null;
var $t_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogPost = null;
var $t_Lcom_sustenage_menta_fontend_exercise_display_blog_data_PageType$__BlogData = null;
$s_Lcom_sustenage_menta_fontend_exercise_display_blog_data_main__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
